...
<div id="app">
    <div style="display: inline-block">
        ...
        <div id="cont" style="float: left;margin-top: 200px;margin-left: 200px">
            <p>这里是添加页面</p>
         <form action="${pageContext.request.contextPath}/group/add">
<input type="text" name="name" placeholder="小组名">
             <input type="text" name="birth" placeholder="创建时间">

             <input type="text" name="deptName" placeholder="部门名">
