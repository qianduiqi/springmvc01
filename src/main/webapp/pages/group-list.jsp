...
<div id="app">
    <div style="display: inline-block">
        ...
        <div id="cont" style="float: left;margin-top: 200px;margin-left: 200px">
            <a href="${pageContext.request.contextPath}/pages/group-add.jsp" style="text-decoration-line: none">添加小组信息</a>
            ...
            <table border="1" >
                ...
                <c:forEach items="${groupList}" var="group">
                    <tr>
                        ...
                        <td>${group.name}</td>
                        <td>${group.birth}</td>
                        <td>${group.dept.name}</td>

                        <td>
                            <a href="${pageContext.request.contextPath}/group/del?id=${group.id}" style="text-decoration-line: none">删除</a></td>
